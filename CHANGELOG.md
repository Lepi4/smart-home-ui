# ALLHA-2D v5.1.0-beta.1 — backup upload safety beta
...
- Docker `BUILD_VERSION` updated to `5.1.0-beta.1`.
- Mobile retry button now has `type="button"` and a null-safe handler.
- Service Worker cache updated to `allha2d-v5.1.0-beta.1`.

# ALLHA-2D v5.1.0-beta.1 — backup path hardening + SQLite LIKE cleanup
...
- Version metadata and Service Worker cache updated to `v5.1.0-beta.1`.

# ALLHA-2D v5.1.0-beta.1 — Sonnet audit micro-hotfix
...
- Updated Service Worker cache name to `allha2d-v5.1.0-beta.1`.
- FAQ/README/version metadata updated to v5.1.0-beta.1.
...
- Full README and FAQ refreshed for v5.1.0-beta.1.
...
- Updated Service Worker cache name to `allha2d-v5.1.0-beta.1`.
- FAQ version now matches v5.1.0-beta.1.
