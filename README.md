...
```text
ghcr.io/lepi4/smart-home-ui-amd64:3.4.26
ghcr.io/lepi4/smart-home-ui-aarch64:3.4.26
```
...
## Что умеет текущая версия v3.4.26
...
```bash
git add .
git commit -m "Update Smart Home UI add-on to v3.4.26"
git push
```
...
## v3.4.26 — data consistency and security
...
## v3.4.26 — mobile panel stability
...
## v3.4.26 — HA Area fallback and edit groups
...
## v3.4.26: Device Picker в режиме редактирования
