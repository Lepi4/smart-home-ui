...
```text
ghcr.io/lepi4/smart-home-ui-amd64:3.4.16
ghcr.io/lepi4/smart-home-ui-aarch64:3.4.16
```
...
## Что умеет текущая версия v3.4.16
...
```bash
git add .
git commit -m "Update Smart Home UI add-on to v3.4.16"
git push
```
...
## v3.4.16 — data consistency and security
...
## v3.4.16 — mobile panel stability
