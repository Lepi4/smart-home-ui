...
```text
ghcr.io/lepi4/smart-home-ui-amd64:3.4.40
ghcr.io/lepi4/smart-home-ui-aarch64:3.4.40
```
...
## Что умеет текущая версия v3.4.40
...
```bash
git add .
git commit -m "Update Smart Home UI add-on to v3.4.40"
git push
```
...
## v3.4.40 — data consistency and security
...
## v3.4.40 — mobile panel stability
...
## v3.4.40 — HA Area fallback and edit groups
...
## v3.4.40: Device Picker в режиме редактирования
...
## v3.4.40 — precise placement and protected sensors
...
## v3.4.40 — Placement Editor Rework
...
## v3.4.40 — Placement Editor coordinate round-trip
...
## v3.4.40 — Unified SVG Layout Editor
...
## v3.4.40 — cleanup old edit mechanisms
...
## v3.4.40 — финальная очистка старого редактора
...
## v3.4.40 — Placement Editor coordinate debug
