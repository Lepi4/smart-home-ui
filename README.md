...
```text
/data/profiles/profile-1/
```

Внутри активного профиля хранятся:
...
Это нужно для будущего управления несколькими профилями: основной план, альтернативный план, тестовый профиль, этажи/области и другие варианты. В v3.5.6 заложена миграция и серверная база. В v3.5.7 добавлен UI управления профилями.
