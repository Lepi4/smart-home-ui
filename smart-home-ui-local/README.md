...
```text
ghcr.io/lepi4/smart-home-ui-amd64:3.4.45
ghcr.io/lepi4/smart-home-ui-aarch64:3.4.45
```
...
## Что умеет текущая версия v3.4.45
...
```bash
git add .
git commit -m "Update Smart Home UI add-on to v3.4.45"
git push
```
...
## v3.4.45 — overview edit accordion
...
## v3.4.45 — grouped edit device panel
...
## v3.4.45 — HA Area fallback and edit groups
...
## v3.4.45: Device Picker в режиме редактирования
...
## v3.4.45 — Placement Editor Rework
...
## v3.4.45 — Placement Editor coordinate round-trip
...
## v3.4.45 — Unified SVG Layout Editor
...
## v3.4.45 — cleanup old edit mechanisms
...
## v3.4.45 — финальная очистка старого редактора
...
## v3.4.45 — Placement Editor coordinate debug
...
## v3.4.45 — Stable Placement Editor Sizing
...
## v3.4.45 — Kiosk Attention Monitor

Добавлена глобальная функция “Внимание!” для kiosk mode. Правило добавляется в существующем long press меню устройства, без второго меню. Нормальным считается состояние entity в момент включения правила. Кнопка “Внимание!” в киоске показывает alert независимо от текущей комнаты. Список правил хранится в `/data/attention_rules.json`; удаление одного правила и очистка всего списка выполняются удержанием 3 секунды и доступны только в admin mode при разблокированном киоске.
