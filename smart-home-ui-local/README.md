...
Это нужно для будущего управления несколькими профилями: основной план, альтернативный план, тестовый профиль, этажи/области и другие варианты. В v3.5.6 заложена миграция и серверная база. В v3.5.7 добавлен UI управления профилями. В v3.5.8 добавлены уровни/области внутри профиля.
